...
Officer: 3154130
CaseNum: 801-0-42954936-3154130
...
- We know that one member of the order is seated in the 3rd row, 4th seat
...
function draw()
{
    ...
    audience[2][3].highlighted=true;
    audience[2][8].highlighted=true;
    audience[4][1].highlighted=true;
    audience[4][5].highlighted=true;
    audience[4][9].highlighted=true;
    audience[8][0].highlighted=true;
    audience[8][3].highlighted=true;
