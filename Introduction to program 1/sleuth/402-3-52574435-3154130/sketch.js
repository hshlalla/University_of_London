...
Officer: 3154130
CaseNum: 402-3-52574435-3154130
...
function draw()
{
	...
	///////////////////ADD YOUR CODE HERE///////////////////
	if (det.locationY > 500 && det.locationX > 753)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
	else if (det.locationY > 499 && det.locationX > 200)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
	else if (det.locationY > 380 && det.locationX > 199)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
	else if (det.locationY > 369 && det.locationX < 580)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
	else if (det.locationY > 256 && det.locationX > 570)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
	else if (det.locationY > 245 && det.locationX > 320)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
	else if (det.locationY > 141 && det.locationX > 310)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
	else if (det.locationY > 124 && det.locationX < 825)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
	else if (det.locationY > 65 && det.locationX > 813)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
    
    else if (det.locationY > 60 && det.locationX >130)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
    else if (det.locationY > 12 && det.locationX > 125)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
