...
Officer: 3154130
CaseNum: 402-2-67751108-3154130
...
function draw()
{
    ...
    else if (det.locationY>433&&det.locationX < 274)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
   
    else if (det.locationX < 524&&det.locationY>431)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
    
    else if (det.locationY > 184&&det.locationX < 526)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
    
    else if (det.locationX < 775&&det.locationY > 182)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
    
    else if (det.locationY > 73&&det.locationX < 789)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
    else if (det.locationX < 889&&det.locationY > 59)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
